...
from Assignment7.loader import TrainLoader, TestLoader, ValidateLoader
from Assignment7.model import Model
from Assignment7.train import TrainTune
from Assignment7.utils import build_transformed_dataset, split_dataset, split_dataset_csv
...
class Runner:  # corresponds to scenario when dataset needs to be loaded and processed from local device, as we work;
    ...
    def run_model(self, model: Model, dataset_csv: bool = False, split_path='',
                  ...
                  transforms_not_cached=None, config=None, model_forward=None):
        ...
        train_tune = TrainTune(model, train_loader, validation_loader, self.writer,
                               ...
                               config=config, model_forward=model_forward)
