...
class NeuralNetwork:
    ...
    def predict(self, x: Vector[np.float32]) -> Vector[np.float32]:
        return self._run_forward_propagation(x)

    def train(self, x: Vector[np.float32], y: Vector[np.float32]) -> None:
    ...
    def _run_forward_propagation(self, x: Vector[np.float32]) -> Vector[np.float32]:
    ...
    def _run_backwards_propagation(self, x: Vector[np.float32], y: Vector[np.float32]) -> None:
    ...
    def _run_loss_function(self, y: Vector[np.float32], y_hat: Vector[np.float32]) -> Vector[np.float32]:
        return y_hat - y
