""""
    This is a network that consists of one output layer with 6 neurons
    The dataset is divided into train set (90%) and test set (10%)
    The accuracy is ~42.5%
    There is also a method [custom] for handmade input
"""
import numpy as np
import pandas as pd
...
class Classifier:
    ...
    def predict(self):
        ...
        print("Percent of correct classified test data is {}%.".format(correct * 100 / len(test_x)))
...
if __name__ == '__main__':
    ...
    learning_rate = 0.05
    steps = 1000
    print("Custom example started..\n")
    classifier.custom(inp, weights, bias, out, learning_rate, steps)
    print("The network has been trained {} times..".format(steps))
    print("\nWine Quality Classifier started..\n")
    classifier.train()
    classifier.predict()
